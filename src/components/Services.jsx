    ...
    <section className="services">
      ...
      <div>
        <div>
          ...
          <p>
            Free cocktails just for your drinking pleasure. Feel free to choose
            from any of our 25 different kinds.
          </p>
        </div>
        <div>
          <svg
          ...
          <p>
            Be sure to explore the amazing and scenic hiking trails we have to
            offer! We provide gear and equipment for you to enjoy hiking as long
            as you like.
          </p>
        </div>
        <div>
          ...
          <h2>Free Shuttle</h2>
          <p>
            Free shuttle rides around all of our local restaurants and be sure
            to take the scenic route to get the most out of your ride.
          </p>
        </div>
        <div>
          <svg
          ...
          <p>
            Strong beer like you have never had before! The beer is locally
            grown and brewed for a more high rich flavor.
          </p>
        </div>
      </div>
    </section>
